...
Bu dosyayı VS Code'da `.github/copilot-instructions.md` olarak kaydet veya Copilot Chat'e
doğrudan yapıştır. Amaç: React tabanlı FinTrack web frontend'ini, Feature-Based (özellik
tabanlı) mimari desende, aşağıdaki backend API'ye uyumlu şekilde geliştirmek.
